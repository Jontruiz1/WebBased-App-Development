<%@ Page Title="" Language="C#" MasterPageFile="~/FinalExam/Site.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FinalExam.FinalExam.Registration" %>
...
<asp:Content ID="MyContent" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    <div>
        ...
        <asp:CheckBox ID="chkPreWorkshop" Text="&nbsp;Pre-Conference Workshop Only: $50" runat="server" AutoPostBack="True" OnCheckedChanged="chkPreWorkshop_CheckedChanged" /><br />
        ...
        <p>
            <b>Registration Subtotal:</b>
            <asp:Label ID="lblSubTotal" runat="server" Text="$575.00"></asp:Label>
        </p>
        ...
        <table cellpadding="3" cellspacing="3">
            <tr>
                <td>
                    <img src="../FinalExam/Images/required.gif" /></td>
                <td width="5"></td>
                <td>Name:</td>
                <td width="5"></td>
                <td>
                ...
                <td width="5"></td>
                <td>
                    <asp:RequiredFieldValidator ID="valBillingName" runat="server" ControlToValidate="txtBillName" CssClass="red" ErrorMessage="Error: Required Field" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator></td>
            </tr>
        ...
        <p>
            <asp:CheckBox ID="chkBillToShip" runat="server" Text="&nbsp; Shipping Address same as Billing" AutoPostBack="True" OnCheckedChanged="chkBillToShip_CheckedChanged" />
        </p>
        ...
        <table cellpadding="3" cellspacing="3">
            <tr>
                ...
                <td width="5"></td>
                <td>
                    <asp:RequiredFieldValidator ID="valShipName" runat="server" ControlToValidate="txtShipName" CssClass="red" ErrorMessage="Error: Required Field" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator></td>
            </tr>
        ...
        <table>
            <tr>
                ...
                <td width="5"></td>
                <td>
                    <asp:TextBox ID="txtJob" runat="server" Height="26px" MaxLength="25"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td width="5"></td>
                <td>
                    <asp:TextBox ID="txtCompany" runat="server" Height="26px" MaxLength="25"></asp:TextBox>
                </td>
                <td width="5" style="height: 28px"></td>
                <td style="height: 28px"></td>
            </tr>
            ...
            <tr>
                <td style="height: 28px">
                    <img src="../FinalExam/Images/required.gif" style="width: 9px; height: 8px" /></td>
                <td width="5" style="height: 28px"></td>
        ...
        <table cellpadding="3" cellspacing="3">
            <tr>
                ...
                <td width="5"></td>
                <td>
                    <asp:TextBox ID="txtPayName" runat="server" MaxLength="50"></asp:TextBox></td>
                <td width="5"></td>
                <td>
                    <asp:RequiredFieldValidator ID="valPayName" runat="server" ControlToValidate="txtPayName" CssClass="red" ErrorMessage="Error: Required Field" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator></td>
            </tr>
